...
(function(Ea, Q, k) {
    var P = function(h) {
        ...
        function ub(a, b) {
            ...
            f = b.iTotalDisplayRecords !== k ? b.iTotalDisplayRecords: b.total;
            if (e) {
        ...
        function ya(a) {
            if (a.oFeatures.bStateSave && !a.bDestroying) {
                var b = {
                    time: +new Date,
                    page: a._iDisplayStart,
                    pageSize: a._iDisplayLength,
        ...
        function Kb(a) {
            ...
            if (a.oFeatures.bStateSave) {
                ...
                if (d && d.time && (b = w(a, "aoStateLoadParams", "stateLoadParams", [a, d]), -1 === h.inArray(!1, b) && (b = a.iStateDuration, !(0 < b && d.time < +new Date - 1E3 * b) && e.length === d.columns.length))) {
                    ...
                    d);
                    d.page !== k && (a._iDisplayStart = d.page, a.iInitDisplayStart = d.page);
                    d.pageSize !== k && (a._iDisplayLength = d.pageSize);
